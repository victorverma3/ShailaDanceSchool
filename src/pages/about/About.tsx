  ...
  return (
    <div className="aboutContent">
      ...
      <p className="aboutText">
        ...
        and Folk style dance forms to students in the Metro West Area of
        Massachusetts. She has adapted the dance forms for the next generation
      ...
      <p className="aboutText">
        ...
        as a strong foundation for their dance education. Not only does she
        teach her students dance forms, but she also teaches them
